...
> **⚠️Note**: Please note that FragPipe versions may vary in output fields, directory structures, and execution commands. When processing 
...
#The FragPipe is from https://github.com/Nesvilab/FragPipe, we only provide the FragPipe for download easy.The version contain some plugins.
