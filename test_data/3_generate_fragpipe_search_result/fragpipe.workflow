# FragPipe (21.1) runtime properties


# Please edit the following path to point to the correct location.
# In Windows, please replace single '\' with '\\'
database.db-path=/home/test_data/3_generate_fragpipe_search_result/20231026_decoys_contam_Homo_sapiens_reviewed.fasta.fas
...
fragpipe-config.bin-diann=/app/FragPipe-21.1/tools/diann/1.8.2_beta_8/linux/diann-1.8.1.8
fragpipe-config.bin-ionquant=/app/FragPipe-21.1/IonQuant-1.10.27/IonQuant-1.10.27.jar
fragpipe-config.bin-msfragger=/app/FragPipe-21.1/MSFragger-4.0/MSFragger-4.0.jar
fragpipe-config.bin-philosopher=/app/FragPipe-21.1/philosopher-v5.1.1
fragpipe-config.bin-python=D\:\\Program Files\\Python\\Python39\\python
freequant.mz-tol=10
...
workdir=/home/test_data/3_generate_fragpipe_search_result
